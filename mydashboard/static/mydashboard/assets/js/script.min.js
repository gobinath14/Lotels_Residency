...
function pieChart(e, t, o, r = "270") {
  var a = {
    ...
    chart: { type: "pie", group: "social", width: o, height: 270 },
    legend: {
      show: !1,
      position: "bottom",
      ...
      fontWeight: 400,
      labels: { colors: "#525768" },
      markers: { width: 7, height: 7, radius: 20, offsetX: -4 },
      itemMargin: { horizontal: 10, vertical: 10 },
      onItemClick: { toggleDataSeries: !0 },
      onItemHover: { highlightDataSeries: !0 },
    },
    plotOptions: { pie: { dataLabels: { minAngleToShowLabel: void 0 } } },
    responsive: [{ breakpoint: 1399, options: { chart: { width: "100%" } } }],
  };
  $(e).length > 0 && new ApexCharts(document.querySelector(e), a).render();
}
function DonutChart(e, t, o, r, a, s, n) {
  var i = {
    series: t,
    labels: a,
    colors: s,
    chart: { type: "donut", group: "social", width: o, height: r },
    legend: { show: !1 },
    plotOptions: {
      pie: {
        dataLabels: { minAngleToShowLabel: void 0 },
        donut: {
          size: n,
          labels: {
            show: !0,
  ...
  $(e).length > 0 && new ApexCharts(document.querySelector(e), i).render();
}
function radialChart(e, t, o, r = "270") {
  var a = {
    series: t,
    ...
    plotOptions: {
      radialBar: {
        hollow: { margin: 0, size: "28%" },
        track: { show: !0, margin: 11 },
        dataLabels: {
          show: !0,
          name: { offsetY: 20 },
          value: {
    ...
    stroke: { lineCap: "round" },
    grid: { padding: { to: 0, right: 0, bottom: 0, left: 0 } },
    labels: ["Target", "Completed", "In Progress"],
  };
  $(e).length > 0 && new ApexCharts(document.querySelector(e), a).render();
}
function barChart(e, t, o = "270") {
  var r = {
    series: [{ data: [400, 430, 448, 470, 540, 580, 690, 1100, 1200, 1380] }],
    colors: ["#8231D3"],
    chart: { width: t, height: o, type: "bar" },
    legend: { show: !1 },
    plotOptions: { bar: { borderRadius: 4, horizontal: !1 } },
...
function groupBarChart(e, t, o = "270") {
  var r = {
    series: [
...
function areaChart(e, t, o = "270") {
  var r = {
    series: [{ data: [44, 55, 41, 64, 22, 43, 21] }],
    colors: ["#8231D3", "#00AAFF"],
    chart: { width: t, height: o, type: "area" },
    legend: { show: !1 },
    dataLabels: { enabled: !1 },
...
const customTooltips = function (e) {
    let a = document.getElementById("chartjs-tooltip");
    a ||
      ((a = document.createElement("div")),
      (a.id = "chartjs-tooltip"),
      (a.className = "chartjs-tooltip"),
      (a.innerHTML = "<table></table>"),
    ...
    if (
      ...
      e.forEach(function (e) {
        o += `<div class='tooltip-title'>${e}</div>`;
      }),
        (o += "</thead><tbody>"),
        r.forEach(function (e, a) {
          const r = t.labelColors[a];
          let n = "background:" + r.backgroundColor;
          (n += "; border-color:" + r.borderColor),
            (n += "; border-width: 2px"),
            (n += "; border-radius: 30px");
          o += `<tr><td>${`<span class="chartjs-tooltip-key" style="${n}"></span>`}${e}</td></tr>`;
        }),
        (o += "</tbody>"),
        (a.querySelector("table").innerHTML = o);
    }
    const r = document.querySelector(".chartjs-tooltip"),
      o = e.chart.canvas.getBoundingClientRect(),
      n = r.clientHeight,
      l = document.querySelector('html[dir="rtl"]');
    (a.style.opacity = 1),
      ...
      (a.style.left =
        ...
        window.pageXOffset +
        t.caretX -
        (null !== l ? r.clientWidth : 0) +
        "px"),
      (a.style.top =
        o.top +
        window.pageYOffset +
        t.caretY -
        (t.caretY > 10 ? (n > 100 ? n + 5 : n + 15) : 70) +
        "px"),
      (a.style.padding = t.padding + "px " + t.padding + "px"),
      (a.style.pointerEvents = "none");
  },
  chartLinearGradient = (e, a, t) => {
    const r = e.getContext("2d").createLinearGradient(0, 0, 0, a);
    return r.addColorStop(0, "" + t.start), r.addColorStop(1, "" + t.end), r;
  };
function chartjsAreaChart(e, a, t, r) {
  let o;
  const n = {
    id: "legendMargin",
    beforeInit(e, a, t) {
      const r = e.legend.fit;
      e.legend.fit = function () {
        return r.bind(e.legend)(), (this.height += 24);
      };
    },
  };
  var l = document.getElementById(e);
  if (l) {
    l.getContext("2d"), (l.height = window.innerWidth <= 575 ? 180 : a);
    new Chart(l, {
      type: "line",
      data: {
        labels: [
        ...
        plugins: {
          legend: {
            ...
            labels: {
              ...
              pointStyleWidth: 6,
              padding: 25,
              font: { size: 16, weight: 400, family: "'Jost', sans-serif" },
            },
          },
          tooltip: {
            usePointStyle: !0,
            ...
            callbacks: {
              label: function (e) {
                ...
                return (
                  a && (a += ": "),
                  null !== e.parsed.y &&
                    (a += new Intl.NumberFormat().format(e.parsed.y)),
                  `<span class="data-label">${a}K</span>`
                );
              },
            },
          },
...
function chartjsBarChart(e, a, t, r, o, n, l) {
  let i;
  var d = document.getElementById(e);
  if (d) {
    d.getContext("2d"),
      (d.height =
        window.innerWidth <= 1399 ? (window.innerWidth < 575 ? 250 : 100) : o);
    new Chart(d, {
      type: "bar",
      data: {
        labels: r,
      ...
      options: {
        ...
        plugins: {
          legend: {
            ...
            position: "bottom",
            align: "start",
            labels: { boxWidth: 6, display: !0, usePointStyle: !0 },
          },
          tooltip: {
            usePointStyle: !0,
            enabled: !1,
...
function chartjsLineChart(e, a, t, r, o, n) {
  let l, i, d;
  ...
  if (s) {
    s.getContext("2d"),
      (s.height =
        window.innerWidth <= 1399 ? (window.innerWidth < 575 ? 200 : 150) : a);
    new Chart(s, {
      type: "line",
      data: {
        labels: r,
        datasets: [
          {
            ...
            borderColor: d,
            backgroundColor: () =>
              chartLinearGradient(document.getElementById(e), 300, {
                start: `rgba(${i},0.5)`,
...
function exampleBarChart(e, a, t) {
  let r;
  ...
  if (o) {
    ...
    new Chart(o, {
      ...
      options: {
        indexAxis: t,
        scales: { y: { stacked: !0, beginAtZero: !0 } },
        animation: {
          onComplete: () => {
            r = !0;
          },
...
function exampleBarStackedChart(e, a, t) {
  let r;
  var o = document.getElementById(e);
  if (o) {
    o.getContext("2d"), (o.height = window.innerWidth <= 575 ? 180 : a);
...
function exampleLineChart(e, a, t) {
  let r;
  var o = document.getElementById(e);
  if (o) {
    o.getContext("2d"), (o.height = window.innerWidth <= 575 ? 180 : a);
    ...
    new Chart(s, {
      ...
      options: {
        ...
        plugins: {
          ...
          tooltip: { usePointStyle: !0, enabled: !0 },
        },
        animation: {
          onComplete: () => {
            l = !0;
...
function exampleRadarChart(e, a) {
  let t;
  var r = document.getElementById(e);
  if (r) {
    r.getContext("2d"), (r.height = window.innerWidth <= 575 ? 180 : a);
    new Chart(r, {
      type: "radar",
      data: {
        labels: [
...
function chartJsBarChartSocial(e, a, t, r, o) {
  let n;
  var l = document.getElementById(e);
  if (l) {
    l.getContext("2d"),
      (l.height = window.innerWidth <= 575 ? 180 : a),
      (l.width = 130);
    new Chart(l, {
      type: "bar",
      data: {
...
function chartjsLineChartProfile(e, a = "#FA8B0C", t = "95", r, o, n) {
  var l = document.getElementById(e);
  let i;
  if (l) {
    l.getContext("2d"), (l.height = window.innerWidth <= 575 ? 190 : t);
    new Chart(l, {
      type: "line",
      data: {
        labels: n,
...
function chartjsLineChartTwo(e, a, t) {
  var r = document.getElementById(e);
  let o;
  if (r) {
    r.getContext("2d"), (r.height = window.innerWidth <= 575 ? 190 : a);
    new Chart(r, {
      type: "line",
      data: {
        labels: [
...
function chartjsLineChartAccount(e, a = "#FA8B0C") {
  var t = document.getElementById(e);
  let r;
  if (t) {
    t.getContext("2d"), (t.height = window.innerWidth <= 575 ? 200 : 100);
    new Chart(t, {
      type: "line",
      data: {
...
function chartjsLineChartOne(
  ...
  t = "#20C99710",
  r = "#20C997",
  o = [5, 10, 20, 25, 20, 30, 15, 25, 15, 10]
) {
  var n = document.querySelectorAll(e);
  n &&
    n.forEach(function (e, n) {
      e.getContext("2d"), (e.height = 115);
      new Chart(e, {
        type: "line",
        data: {
        ...
        options: {
          ...
          layout: { padding: { left: -13, right: 0, top: 0, bottom: 0 } },
          elements: { point: { radius: 0 } },
          scales: {
            y: {
              display: !1,
              grid: { display: !1, color: "#485e9029" },
              ticks: {
                beginAtZero: !0,
                fontSize: 10,
                display: !1,
            ...
            x: {
              display: !1,
              grid: { display: !1 },
              ticks: { beginAtZero: !0, fontSize: 11, display: !1 },
            },
          },
        },
      });
...
function fOverviewWeek() {
  chartjsLineChartOne(
    ...
    (bgColor = "#20C99710"),
    (bColor = "#20C997"),
    (data = [1e3, 5e3, 1500, 1e4, 14e3, 24e3, 2e4])
  ),
    chartjsLineChartOne(
      "#lineChartSix",
      (label = "Label"),
      (bgColor = "#E34A8710"),
      (bColor = "#FF69A5"),
      (data = [1e4, 15e3, 1e4, 15e3, 14e3, 24e3, 2e4])
    ),
    chartjsLineChartOne(
      "#lineChartSeven",
      (label = "Label"),
...
function fOverviewMonth() {
  chartjsLineChartOne(
    ...
    (bgColor = "#20C99710"),
    (bColor = "#20C997"),
    (data = [15e3, 5e4, 15e3, 15e3, 4e4, 24e3, 2e4])
  ),
    chartjsLineChartOne(
      "#lineChartTen",
      (label = "Label"),
      (bgColor = "#E34A8710"),
      (bColor = "#FF69A5"),
      (data = [2e4, 4e4, 16e3, 15e3, 3e4, 23e3, 25e3])
    ),
    chartjsLineChartOne(
      "#lineChartEleven",
      (label = "Label"),
      (bgColor = "#0D79DF10"),
      (bColor = "#5F63F2"),
      (data = [5e3, 4e3, 16e3, 1e4, 2e4, 13e3, 1e4, 6e3])
    ),
    chartjsLineChartOne(
      "#lineChartTwelve",
      (label = "Label"),
...
function fOverviewYear() {
  chartjsLineChartOne(
    ...
    (bColor = "#20C997"),
    (data = [
      95e3, 19e3, 55e3, 9e4, 24e4, 95e3, 55e3, 19e3, 55e3, 66e3, 9e4, 24e4,
    ])
  ),
    chartjsLineChartOne(
      "#lineChartFourteen",
      ...
      (bColor = "#FF69A5"),
      (data = [
        98e3, 2e4, 55e3, 9e4, 24e4, 95e3, 55e3, 19e3, 55e3, 66e3, 9e4, 24e4,
      ])
    ),
    chartjsLineChartOne(
      "#lineChartFifteen",
      ...
      (bColor = "#5F63F2"),
      (data = [
        9500, 1900, 5500, 9e3, 24e3, 9500, 5500, 1900, 5500, 9e3, 1e4, 24e3,
      ])
    ),
    chartjsLineChartOne(
      "#lineChartSixteen",
      ...
      (bColor = "#FA8B0C"),
      (data = [
        5e3, 19e3, 15e3, 19e3, 2e4, 35e3, 2e4, 19e3, 27e3, 1e4, 15e3, 2e4,
      ])
    );
}
function chartjsBarChartInEx(e, a, t, r, o, n, l = "Bar chart Income Expense") {
  var i = document.getElementById(e);
  if (i) {
    i.getContext("2d"), (i.height = window.innerWidth <= 575 ? 180 : 84);
    new Chart(i, {
      type: "bar",
      data: {
        labels: n,
...
function chartjsLineChartForcast(
  ...
  r = "#5F63F202",
  o = "#20C997",
  n = [30, 10, 20, 25, 20, 30, 15, 25, 15, 10]
) {
  var l = document.querySelectorAll(e);
  l &&
    l.forEach(function (e, t) {
      e.getContext("2d"), (e.height = 95);
      new Chart(e, {
        type: "line",
        data: {
          labels: [
...
function chartjsLineChartSmall(
  ...
  var o = document.getElementById(e);
  if (o) {
    o.getContext("2d"), (o.height = 30), (o.width = "100");
    new Chart(o, {
      type: "line",
      data: {
...
chartjsAreaChart("salesReports", "105", "Total Order", "Total Order"),
  chartjsBarChart(
    "salesGrowthToday",
  ...
  exampleBarChart("barChartVertical", "105", !1),
  exampleBarChart("barChartHorizontal", "105", "y"),
  exampleBarStackedChart("barChartStacked", "105", !1),
  exampleLineChart("lineChartBasic", "105", !1),
  exampleAreaChart(
    "areaChartBasic",
    "105",
    (data = [0, 28, 30, 45, 40, 50, 25, 70, 35, 40, 26, 58]),
  ...
  $("#f_week-tab").on("shown.bs.tab", function () {
    fOverviewWeek(), $("#f_week-tab").off();
  }),
  $("#f_month-tab").on("shown.bs.tab", function () {
    fOverviewMonth(), $("#f_month-tab").off();
  }),
  $("#f_year-tab").on("shown.bs.tab", function () {
    fOverviewYear(), $("#f_year-tab").off();
  }),
  ...
  (FooTable.MyFiltering = FooTable.Filtering.extend({
    ...
    $create: function () {
      ...
      var t = this,
        e = $("<div/>", {
          class:
            "form-group dm-select d-flex align-items-center adv-table-searchs__position my-xl-25 my-15 me-sm-20 me-0 ",
        })
          .append(
            $("<label/>", {
      ...
      var s = $("<div/>", {
        class:
          "form-group dm-select d-flex align-items-center adv-table-searchs__status my-xl-25 my-15 mb-0 me-sm-30 me-0",
      })
        .append(
          $("<label/>", {
            class: "d-flex align-items-center mb-sm-0 mb-2",
        ...
        .prependTo(t.$form);
      (t.$jobTitle = $("<select/>", { class: "form-control ms-sm-10 ms-0" })
...
!(function () {
  ...
  function e(e, t, l, r, o) {
    ...
    new google.maps.Marker({
      position: s,
      icon:
        o || ("undefined" != typeof env && env.googleMarkerUrl)
          ? env.googleMarkerUrl
          : "img/markar-icon.png",
    }).setMap(a);
  }
      ...
      $("#google-map-theme").length &&
        e("google-map-theme", 50.797897, -1.077641, [
          ...
          },
          {
            featureType: "administrative",
            elementType: "geometry",
            stylers: [{ weight: 0.6 }, { color: "#fff" }, { gamma: "0" }],
          },
          {
            featureType: "landscape",
            elementType: "geometry",
            stylers: [{ color: "#5F63F2" }, { gamma: "1" }, { weight: "10" }],
          },
          {
            featureType: "poi",
            elementType: "geometry",
...
$.getJSON(
  "undefined" != typeof env && env.iconLoaderUrl
    ? env.iconLoaderUrl
    : "json/icons.json",
  function (n) {
    const { faIcons: s } = n,
    ...
    $(".faIcon-list-box").append(o), $(".laIcon-list-box").append(a);
    const i = l.map(
      (n) =>
        `\n                <div class="col-sm-6 col-md-4 col-lg-3">\n                    <i class="uil uil-${n}"></i>\n                    <span class="icon-text">${n}</span>\n                </div>\n            `
    );
    $(".feIcon-list-box").append(i);
  }
);
...
$("#sb_location-month-tab").on("shown.bs.tab", function () {
  $(regionMapM).vectorMap({
    ...
    regionStyle: {
      ...
      hover: { fill: "var(--color-primary)", "fill-opacity": 1 },
    },
    markerStyle: {
      initial: {
...
!(function (e) {
  const a = document.getElementById("leaflet-basic"),
    t = document.getElementById("leaflet-multiIcon"),
    i = document.getElementById("leaflet-customIcon"),
    o = document.getElementById("leaflet-cluster");
  if (a) {
    var s = L.map(a).setView([51.505, -0.09], 13);
    L.tileLayer(
    ...
    var r = L.marker([51.5, -0.09]).addTo(s);
  }
  if (t) {
    ...
    let e = L.marker([51.509, -0.08]).bindPopup("This is Littleton, CO."),
      a = L.marker([51.503, -0.06]).bindPopup("This is Littleton, CO."),
      t = L.marker([51.51, -0.09]).bindPopup("This is Littleton, CO.");
    L.layerGroup([e, a, t]).addTo(m);
  }
  if (i) {
    var n = L.map("leaflet-customIcon").setView([51.505, -0.09], 13);
    L.tileLayer(
      "https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token=pk.eyJ1IjoibWFwYm94IiwiYSI6ImNpejY4NXVycTA2emYycXBndHRqcmZ3N3gifQ.rJcFIG214AriISLbB6B5aw",
      {
        maxZoom: 30,
    ...
    var p = L.icon({
      iconUrl:
        "undefined" != typeof env && env.mapClockIcon
          ? env.mapClockIcon
          : "img/svg/clock-ticket1.svg",
      iconSize: [38, 95],
    });
    r = L.marker([51.5, -0.09], { icon: p }).addTo(n);
  }
  if (o) {
    let e = [
      ...
      a = L.map("leaflet-cluster").setView([-37.82, 175.23], 13);
    L.tileLayer(
      "https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token=pk.eyJ1IjoibWFwYm94IiwiYSI6ImNpejY4NXVycTA2emYycXBndHRqcmZ3N3gifQ.rJcFIG214AriISLbB6B5aw",
      {
        attribution:
    ...
    for (var c = L.markerClusterGroup(), l = 0; l < e.length; l++) {
      var h = (s = e[l])[2];
      (r = L.marker(new L.LatLng(s[0], s[1]), { title: h })).bindPopup(h),
        c.addLayer(r);
    }
    a.addLayer(c);
  }
...
!(function (e) {
  ...
  e(".table-responsive--dynamic .dropdown").on("show.bs.dropdown", function () {
    ...
    e(".table-responsive--dynamic .dropdown").on(
      "hidden.bs.dropdown",
      function () {
        e(this)
          .find(".table-responsive--dynamic .dropdown-menu")
          .data("open", !1);
      }
    ),
    e(".table-responsive--dynamic").scroll(function () {
      ...
      a.data("open") &&
        (a.css({
          top: s.offset().top + s.outerHeight(!0) + "px",
          left: s.offset().left + "px",
        }),
        t.toggleClass("open", s.offset().left > e(this).offset().left));
    }),
    e(
    ...
    e("#datepicker").on("clcik", function () {
      "add" == this.id
        ? e(".ui-datepicker").addClass("myClass", "fast")
        : e(".ui-datepicker").removeClass("myClass", "fast");
    }),
    e("body").on("click", "#datepicker,#datepicker2", function () {
      e(this).closest("body").addClass("datePicker-active");
    }),
    e("body").on("click", function (t) {
      e(t.target).closest("#datepicker,#datepicker2").length ||
        e("body").removeClass("datePicker-active");
    }),
    ...
    e("body").on("click", function (t) {
      window.matchMedia("(max-width: 1151px)").matches &&
        ...
        e(".footer-wrapper").addClass("expanded"));
    });
  ...
  s &&
    ...
    e(window).on("scroll", function (e) {
      ...
      null != t &&
        null != s &&
        (window.pageYOffset <= t.offsetTop
          ? s.classList.remove("show")
          : window.pageYOffset >= t.offsetTop &&
            window.pageYOffset <= t.offsetTop + t.clientHeight - 700
    ...
    e(".sidebar_nav .has-child >a").on("click", function (t) {
      t.preventDefault(),
        ...
        e(this).next().is(":visible")
          ...
          : (e(this).parent().addClass("open"), e(this).next().slideDown());
    }),
    e(window)
      .bind("resize", function () {
        window.innerWidth;
        e(this).width() <= 767.98
          ? (e(".navbar-right__menu").appendTo(".mobile-author-actions"),
            e(".contents").addClass("expanded"),
            e(".sidebar ").addClass("collapsed"))
      ...
      document
        ...
        .addEventListener("click", function () {
          ...
          (e = ".payment-invoice"),
            ...
            (s = document.querySelector(e).innerHTML),
  ...
  var a = {
    ...
    r = {
      ...
      responsive: [
        {
          breakpoint: 1899,
          settings: { slidesToShow: 3, slidesToScroll: 1, centerMode: !0 },
        },
  ...
  Array.from(v).forEach((e) =>
    ...
    e(".kb__select-wrapper select,.tagSelect-rtl select").select2({
      dir: "rtl",
      dropdownAutoWidth: !0,
      dropdownParent: e(".kb__select-wrapper .select2,.tagSelect-rtl .select2"),
    });
  ...
  e(".modal--selected").length) &&
    new bootstrap.Modal(document.querySelector(".modal--selected")).show();
  ...
  function x(e) {
    e.preventDefault(),
      "basic" == this.dataset.drawer
        ? (b.classList.remove("account"),
          b.classList.remove("profile"),
  ...
  w && w.forEach((e) => e.addEventListener("click", x)),
    y && y.addEventListener("click", T),
    C && C.forEach((e) => e.addEventListener("click", T)),
  ...
  function F() {
    "level-one" == this.dataset.drawer
      ? (k.classList.add("level-one"),
        k.classList.add("show"),
        k.classList.remove("level-two"),
        y.classList.add("show"))
      : "level-two" == this.dataset.drawer &&
        (k.classList.add("level-two"),
  ...
  q &&
    ...
    e("#select-search,.kb__select,.select-search").select2({
    ...
    e("#mail-message, #mail-reply-message").trumbowyg({
      svgPath:
        "undefined" != typeof env && env.editorIconUrl
          ? env.editorIconUrl
          : "img/ui/icons.svg",
      btns: [
        ["viewHTML"],
    ...
    e(".toggle-password2").click(function () {
      e(this).toggleClass("uil-eye"),
        (input = e(this).parent().find("#password-field")),
    ...
    e(".mailbar-toggle").on("click", function () {
      e(".dm-mail-sidebar").toggleClass("show");
    }),
    e(".mailbar-cross").on("click", function (t) {
      t.preventDefault(), e(".dm-mail-sidebar").removeClass("show");
    }),
    ...
    e(".price-slider").slider({
      ...
      values: [0, 2e3],
      slide: function (t, s) {
        e(".price-value").text("$" + s.values[0] + " - $" + s.values[1]),
          e(".job-value").text(s.values[0] + " miles"),
          e(".job-value2").text(s.values[1] + " miles");
      },
    }),
    e(".price-value").text(
      "$" +
    ...
    e(".job-value").text(e(".price-slider").slider("values", 0) + " miles"),
    e(".job-value2").text(e(".price-slider").slider("values", 1) + " miles"),
    ...
    e(".fc-listMonth-button").on("click", function () {
      document.querySelectorAll(".fc-list-table");
    }),
    e(".open-popup-modal").each(function (t, s) {
      e(s).on("click", function () {
        e(this).siblings(".popup-overlay").fadeIn("slow").addClass("active"),
          e(this)
    ...
    e(".limit-list-item ul").each(function () {
      e(this).find("li").length > 5 &&
        (e("li", this).eq(4).nextAll().hide().addClass("toggleable"),
        e(this).append('<li class="mt-2 more">See more</li>'));
    }),
    e(".limit-list-item ul").on("click", ".more", function () {
      e(this).hasClass("less")
        ? e(this).text("See more").removeClass("less")
        : e(this).text("See less").addClass("less"),
        e(this).siblings("li.toggleable").slideToggle();
    }),
    e("body").on("click", function (t) {
  ...
  B.forEach((e) => {
    e.addEventListener("mouseover", function () {
      ...
      (s.style.top = t.top + "px"),
        "ltr" === z
          ? (s.style.left =
              t.left + Math.round(0.75 * e.offsetWidth) + 10 + "px")
          : "rtl" === z &&
            (s.style.right = Math.round(0.75 * e.offsetWidth) + 10 + "px");
    });
  });
  ...
  function Q(t) {
    t.preventDefault(),
      "label" == this.dataset.trigger
        ...
        : "compose" == this.dataset.trigger && $.classList.add("show"),
      e(t.target).hasClass("label-close") && H.classList.remove("show");
  }
  function U(e) {
    e.preventDefault(),
      "label" == this.dataset.trigger
        ? H.classList.remove("show")
        : "compose" == this.dataset.trigger && $.classList.remove("show");
  }
  null !== I &&
    null !== j &&
    (I.addEventListener("click", Q), P.addEventListener("click", Q)),
    null !== j &&
      null !== W &&
      (j.addEventListener("click", U), W.addEventListener("click", U));
  ...
  document.getElementsByClassName("new-member__2").length &&
    new bootstrap.Modal(document.getElementById("new-member2")).show();
  document.getElementsByClassName("add-contact__2").length &&
    new bootstrap.Modal(document.getElementById("add-contact")).show();
  ...
  e(".enable-dark-mode").click(function () {
    e("body").toggleClass("layout-dark"),
      e(".enable-dark-mode a").toggleClass("active");
  }),
    G &&
      (G.forEach((e) => e.addEventListener("click", X)),
      G.forEach((e) => e.addEventListener("click", ee)));
  ...
  function te(t, s, a) {
    var i, l;
    try {
      (l = e.datepicker.parseDate(a, t)),
        e.datepicker.parseDate(a, s) < l && ((i = t), (t = s), (s = i));
    } catch (e) {}
  ...
  J &&
    ...
    V &&
      Z &&
      (V.addEventListener("click", ee), Z.addEventListener("click", ee)),
    ...
    (e.fn.dateRangePicker = function (t) {
      ...
      function r(a, i) {
        var l, o;
        (a = a.split(t.rangeSeparator)).length > 0
          ? ((l = e.datepicker.parseDate(i, a[0])),
            a.length > 1 && (o = e.datepicker.parseDate(i, a[1])),
            (s = { start: l, end: o }))
          : (s = null);
      }
      return (
          ...
          if (l.rangeStart) {
            if (((l.inline = !1), (o = l.rangeStart) !== s)) {
              var n = a.datepicker("option", "dateFormat"),
                r = te(o, s, n);
              if (
                (a.val(r.start + t.rangeSeparator + r.end),
                (l.rangeStart = null),
        ...
        this.each(function () {
          a.is("input") && a.datepicker(t),
            a.wrap('<div class="dateRangeWrapper"></div>');
        })
      );
    }),
    e(document).ready(function () {
